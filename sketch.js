...
bottomGround = createSprite(200,420,800,20);
...
if(topObstaclesGroup.isTouching(balloon) || balloon.isTouching(bottomGround) || balloon.isTouching(topGround) || balloon.isTouching(bottomObstaclesGroup))
{
